...
#ifdef TOOLS_ENABLED
bool BoxContainer3D::has_gizmo_plugin = false;
#endif

void BoxContainer3D::_bind_methods() {
    ClassDB::bind_method(D_METHOD("set_alignment", "alignment"), &BoxContainer3D::set_alignment);
    ClassDB::bind_method(D_METHOD("get_alignment"), &BoxContainer3D::get_alignment);
    ADD_PROPERTY(PropertyInfo(Variant::INT, "alignment", PROPERTY_HINT_ENUM, "Begin,Center,End"), "set_alignment", "get_alignment");

    ClassDB::bind_method(D_METHOD("set_positioning", "positioning"), &BoxContainer3D::set_positioning);
    ClassDB::bind_method(D_METHOD("get_positioning"), &BoxContainer3D::get_positioning);
    ...
    ClassDB::bind_method(D_METHOD("set_space_fill_mode", "mode"), &BoxContainer3D::set_space_fill_mode);
    ClassDB::bind_method(D_METHOD("get_space_fill_mode"), &BoxContainer3D::get_space_fill_mode);
    ...
    ClassDB::bind_method(D_METHOD("set_container_size", "size"), &BoxContainer3D::set_container_size);
    ClassDB::bind_method(D_METHOD("get_container_size"), &BoxContainer3D::get_container_size);
    ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "container_size"), "set_container_size", "get_container_size");

    ClassDB::bind_method(D_METHOD("set_spacing", "spacing"), &BoxContainer3D::set_spacing);
    ClassDB::bind_method(D_METHOD("get_spacing"), &BoxContainer3D::get_spacing);
    ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "spacing"), "set_spacing", "get_spacing");

    ClassDB::bind_method(D_METHOD("set_tween_duration", "duration"), &BoxContainer3D::set_tween_duration);
    ClassDB::bind_method(D_METHOD("get_tween_duration"), &BoxContainer3D::get_tween_duration);
    ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "tween_duration"), "set_tween_duration", "get_tween_duration");

    ClassDB::bind_method(D_METHOD("set_tween_overshoot", "overshoot"), &BoxContainer3D::set_tween_overshoot);
    ClassDB::bind_method(D_METHOD("get_tween_overshoot"), &BoxContainer3D::get_tween_overshoot);
    ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "tween_overshoot"), "set_tween_overshoot", "get_tween_overshoot");

    ClassDB::bind_method(D_METHOD("set_tween_new_element_offset", "offset"), &BoxContainer3D::set_tween_new_element_offset);
    ClassDB::bind_method(D_METHOD("get_tween_new_element_offset"), &BoxContainer3D::get_tween_new_element_offset);
    ...
    ClassDB::bind_method(D_METHOD("set_tween_ease_type", "type"), &BoxContainer3D::set_tween_ease_type);
    ClassDB::bind_method(D_METHOD("get_tween_ease_type"), &BoxContainer3D::get_tween_ease_type);
    ...
    ClassDB::bind_method(D_METHOD("set_tween_transition_type", "type"), &BoxContainer3D::set_tween_transition_type);
    ClassDB::bind_method(D_METHOD("get_tween_transition_type"), &BoxContainer3D::get_tween_transition_type);
    ...
    ClassDB::bind_method(D_METHOD("set_vertical", "vertical"), &BoxContainer3D::set_vertical);
    ClassDB::bind_method(D_METHOD("is_vertical"), &BoxContainer3D::is_vertical);
    ADD_PROPERTY(PropertyInfo(Variant::BOOL, "vertical"), "set_vertical", "is_vertical");

    ClassDB::bind_method(D_METHOD("set_layout_axis", "axis"), &BoxContainer3D::set_layout_axis);
    ClassDB::bind_method(D_METHOD("get_layout_axis"), &BoxContainer3D::get_layout_axis);
    ADD_PROPERTY(PropertyInfo(Variant::INT, "layout_axis", PROPERTY_HINT_ENUM, "X,Y,Z"), "set_layout_axis", "get_layout_axis");

    ClassDB::bind_method(D_METHOD("queue_sort"), &BoxContainer3D::queue_sort);
    ClassDB::bind_method(D_METHOD("_resort"), &BoxContainer3D::_resort);
    ...
    BIND_ENUM_CONSTANT(POSITION_TWEEN);
...
BoxContainer3D::BoxContainer3D(bool p_vertical) {
    vertical = p_vertical;
}

BoxContainer3D::~BoxContainer3D() {
    tracking_objects.clear();
}

void BoxContainer3D::queue_sort() {
	if (!is_inside_tree()) {
		return;
	}
	...
	callable_mp(this, &BoxContainer3D::_resort).call_deferred();
	pending_sort = true;
}

void BoxContainer3D::_notification(int p_what) {
    switch (p_what) {
        case NOTIFICATION_ENTER_TREE:
#ifdef TOOLS_ENABLED
            if (!has_gizmo_plugin && Engine::get_singleton()->is_editor_hint()) {
                has_gizmo_plugin = true;
                Ref<BoxContainer3DGizmoPlugin> gizmo_plugin;
...
AABB BoxContainer3D::get_child_bounds(Node3D *p_child) const {
...
Vector3 BoxContainer3D::calculate_child_scale(Node3D *p_child, const AABB &p_bounds) const {
...
// Getters and setters
void BoxContainer3D::set_alignment(AlignmentMode p_alignment) {
    if (alignment == p_alignment) return;
    alignment = p_alignment;
    queue_sort();
}

BoxContainer3D::AlignmentMode BoxContainer3D::get_alignment() const {
    return alignment;
}

void BoxContainer3D::set_positioning(PositioningMethod p_positioning) {
    positioning = p_positioning;
}

BoxContainer3D::PositioningMethod BoxContainer3D::get_positioning() const {
    return positioning;
}

void BoxContainer3D::set_space_fill_mode(SpaceFillMode p_mode) {
    if (space_fill_mode == p_mode) return;
    space_fill_mode = p_mode;
    queue_sort();
}

BoxContainer3D::SpaceFillMode BoxContainer3D::get_space_fill_mode() const {
    return space_fill_mode;
}

void BoxContainer3D::set_container_size(Vector3 p_size) {
...
Vector3 BoxContainer3D::get_container_size() const {
    return container_size;
}

void BoxContainer3D::set_spacing(float p_spacing) {
    if (spacing == p_spacing) return;
    spacing = p_spacing;
    queue_sort();
}

float BoxContainer3D::get_spacing() const {
    return spacing;
}

void BoxContainer3D::set_tween_duration(float p_duration) {
    tween_duration = p_duration;
}

float BoxContainer3D::get_tween_duration() const {
    return tween_duration;
}

void BoxContainer3D::set_tween_overshoot(float p_overshoot) {
    tween_overshoot = p_overshoot;
}

float BoxContainer3D::get_tween_overshoot() const {
    return tween_overshoot;
}

void BoxContainer3D::set_tween_new_element_offset(Vector3 p_offset) {
    new_element_offset = p_offset;
}

Vector3 BoxContainer3D::get_tween_new_element_offset() const {
    return new_element_offset;
}

void BoxContainer3D::set_tween_ease_type(Tween::EaseType p_type) {
    tween_ease_type = p_type;
}

Tween::EaseType BoxContainer3D::get_tween_ease_type() const {
    return tween_ease_type;
}

void BoxContainer3D::set_tween_transition_type(Tween::TransitionType p_type) {
    tween_transition_type = p_type;
}

Tween::TransitionType BoxContainer3D::get_tween_transition_type() const {
    return tween_transition_type;
}

void BoxContainer3D::set_vertical(bool p_vertical) {
    if (vertical == p_vertical) return;
    vertical = p_vertical;
    queue_sort();
}

bool BoxContainer3D::is_vertical() const {
    return vertical;
}

void BoxContainer3D::set_layout_axis(LayoutAxis p_axis) {
...
BoxContainer3D::LayoutAxis BoxContainer3D::get_layout_axis() const {
    return layout_axis;
}
...
void BoxContainer3D::_validate_property(PropertyInfo &p_property) const {
    ...
    if (p_property.name.begins_with("tween_") && positioning != POSITION_TWEEN) {
        p_property.usage = PROPERTY_USAGE_NONE;
    }
}
