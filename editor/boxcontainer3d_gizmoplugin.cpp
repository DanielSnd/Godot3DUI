...
#include "boxcontainer3d_gizmoplugin.h"
#include "editor/editor_node.h"
#include "editor/settings/editor_settings.h"
#include "scene/3d/mesh_instance_3d.h"

bool BoxContainer3DGizmoPlugin::has_gizmo(Node3D *p_spatial) {
    return Object::cast_to<BoxContainer3D>(p_spatial) != nullptr;
}

String BoxContainer3DGizmoPlugin::get_gizmo_name() const {
    return "BoxContainer3D";
}

int BoxContainer3DGizmoPlugin::get_priority() const {
    return -1;
}

void BoxContainer3DGizmoPlugin::redraw(EditorNode3DGizmo *p_gizmo) {
    BoxContainer3D *container = Object::cast_to<BoxContainer3D>(p_gizmo->get_node_3d());
    if (!container) {
        return;
    }
...
BoxContainer3DGizmoPlugin::BoxContainer3DGizmoPlugin() {
