...
class Button3D : public Control3D {
    GDCLASS(Button3D, Control3D);
...
public:
    ...
    void set_style_box(const Ref<StyleBoxFlat> &p_style_box);
	Ref<StyleBoxFlat> get_style_box() const;
    ...
    void set_box_depth(float p_depth);
    float get_box_depth() const;
...
VARIANT_ENUM_CAST(Button3D::DrawFlags);
VARIANT_ENUM_CAST(Button3D::AlphaCutMode);
